...
| ID | Title | Status |
|---|---|---|
| E1 | Navigation data + Topbar fix (`src/data/chapters.js`, rewire Sidebar/Topbar, fix stale 17-chapter list) | PENDING |
| E2 | Citations render fix (`[[1]]` bug) + data normalize + linked inline markers | PENDING |
| E3 | Scroll correctness — TOC/MobileNav offset math, scroll-reset on route change, hash deep-links | PENDING |
...
| ID | Title | Status |
|---|---|---|
| V1 | Math notation sweep (𝔼, 𝓛, matrix-orientation convention, d_k, W_i^Q, τ/T, ch01 pseudo-LaTeX) | PENDING |
...
| ID | Title | Status |
|---|---|---|
| C2 | Ch02 Statistical Learning — deep pass (Appendix A: ch01→02) | PENDING |
| C3 | Ch03 Neural Networks — deep pass (Appendix A: ch02→03) | PENDING |
| C4 | Ch04 Optimization — deep pass (Appendix A: ch03→04) | PENDING |

...
//
// V2 curriculum (25 chapters, 7 parts — see src/data/chapters.js).
...
const Interpretability      = lazy(() => import("./pages/ch23/Interpretability"));
    ...
    <BrowserRouter>
      <Routes>
        <Route path="/" element={<Layout />}>
          ...
          <Route path="ch/23" element={L(Interpretability)} />

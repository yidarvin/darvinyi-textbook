...
const RAW = {
  king:     [ 0.82,  0.74,  0.68, -0.20,  0.12,  0.04, -0.10,  0.46],
  queen:    [ 0.80,  0.76, -0.68, -0.14,  0.07, -0.05, -0.03,  0.46],
  prince:   [ 0.78,  0.70,  0.48, -0.10,  0.15,  0.03, -0.13,  0.02],
  princess: [ 0.84,  0.68, -0.48, -0.24,  0.18,  0.06, -0.05, -0.02],
  throne:   [ 0.68,  0.50,  0.00, -0.18,  0.04,  0.08, -0.06,  0.18],
  man:      [ 0.76,  0.04,  0.60, -0.13,  0.05,  0.06,  0.26,  0.02],
  woman:    [ 0.67, -0.05, -0.60, -0.04, -0.04,  0.18,  0.15, -0.02],
  boy:      [ 0.78,  0.07,  0.60, -0.06,  0.06,  0.04,  0.24,  0.03],
  girl:     [ 0.63,  0.06, -0.60, -0.15,  0.03,  0.15,  0.28, -0.03],
  person:   [ 0.74, -0.03,  0.00, -0.02, -0.05,  0.07,  0.13,  0.02],
  ...
  Paris:    [-0.05, -0.64,  0.06,  0.40,  0.73,  0.36,  0.30, -0.06],
  France:   [-0.16, -0.74,  0.17, -0.20,  0.85,  0.22,  0.30, -0.15],
  Rome:     [-0.02, -0.65,  0.15,  0.40,  0.86,  0.25,  0.30, -0.04],
  Italy:    [-0.14, -0.63,  0.04, -0.20,  0.75,  0.37,  0.30, -0.02],
  London:   [-0.04, -0.75,  0.18,  0.40,  0.84,  0.35, -0.30, -0.16],
  England:  [-0.17, -0.62,  0.05, -0.20,  0.74,  0.24, -0.30, -0.05],
...
export default function SemanticArithmetic({ tryThis }) {
  ...
  return (
    <WidgetCard title="Semantic Arithmetic — vector equations over word meanings" number="7.3" tryThis={tryThis}>

...
export const PARTS = [
  {
    ...
    chapters: [
      ...
      { num: "05", title: "Training Techniques", widgets: 5, live: true, sections: [{ id: "normalization", label: "Normalization" }, { id: "dropout-regularization", label: "Dropout" }, { id: "weight-initialization", label: "Initialization" }, { id: "knowledge-distillation", label: "Distillation" }, { id: "gradient-clipping", label: "Gradient Clipping" }] },
  ...
  },
  {
    ...
    chapters: [
      ...
      { num: "09", title: "Attention", widgets: 3, live: true, sections: [{ id: "the-bottleneck-problem", label: "The Bottleneck" }, { id: "scaled-dot-product-attention", label: "Dot-Product Attention" }, { id: "self-cross-attention-and-masking", label: "Cross-Attention & Masking" }, { id: "multi-head-attention", label: "Multi-Head Attention" }] },

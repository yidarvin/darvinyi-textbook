...
const CITATIONS = buildCitations([
  ...
  "gpt3",
  "bert",
  { title: "Exploring the Limits of Transfer Learning with T5", authors: "Raffel, Shazeer, Roberts, Lee, Narang, Matena, Zhou, Li, Liu", venue: "JMLR", year: "2020", tag: "seminal" },
  { title: "GQA: Training Generalized Multi-Query Transformer Models from Multi-Head Checkpoints", authors: "Ainslie, Lee-Thorp, de Jong, Zelaski, Sanghai, Xu", venue: "EMNLP", year: "2023", tag: "paper" },
  "roformer",
  { title: "Mixtral of Experts", authors: "Jiang, Sablayrolles, Roux, Mensch, Savary, Bamford, Chaplot, de las Casas, Hanna, Bressand, Lengyel, Bour, Lample, Lavaud, Saulnier, Lachaux, Stock, Subramanian, Yang, Antoniak, Scao, Gervet, Muennighoff, Villanova, Naval, Bach, Lacroix", venue: "arXiv", year: "2024", tag: "paper" },
  { title: "LLaMA: Open and Efficient Foundation Language Models", authors: "Touvron, Lavril, Izacard, Martinet, Lachaux, Lacroix, Rozière, Goyal, Hambro, Azhar, Rodriguez, Joulin, Grave, Lample", venue: "arXiv", year: "2023", tag: "paper" },
  "flashattention",
]);

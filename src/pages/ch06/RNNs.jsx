...
import RNNSequenceModes from "../../components/diagrams/ch06/RNNSequenceModes";
import GradientMagnitudeOverTime from "../../components/diagrams/ch06/GradientMagnitudeOverTime";
import LSTMCellDiagram from "../../components/diagrams/ch06/LSTMCellDiagram";
import Seq2SeqEncoderDecoder from "../../components/diagrams/ch06/Seq2SeqEncoderDecoder";
  ...
  return (
    ...
    >
      ...
      <p style={prose}>
        ...
        <em> Gradient clipping</em> (Pascanu, Mikolov & Bengio 2013, covered in Ch 4)
...
\\end{aligned}$$`}</MathBlock>
      ...
      <p style={prose}>
        ...
        Chapter 7 picks up exactly here, with the attention mechanism (Bahdanau, Cho &

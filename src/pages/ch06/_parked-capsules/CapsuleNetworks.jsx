// PARKED — not wired into any route. Capsule Networks was demoted from a
// standalone chapter to a historical sidebar inside Chapter 6 (Convolutional
// Networks) per the V2 curriculum (context/V2_PLAN.md, Appendix A: ch15).
// Queue item C6 folds the "why capsules lost" postmortem + invariance/
// equivariance framing from this file into ConvNets.jsx as one section, then
// deletes this file. Its critique found 3 widgets whose simulations
// contradict their own displayed data (DynamicRouting, CnnVsCapsnet,
// RoutingByAgreement) — those should NOT survive the merge as-is.
...
import CnnVsCapsnet from "../../../components/widgets/ch06/_parked-capsules/CnnVsCapsnet";
import CapsuleVector from "../../../components/widgets/ch06/_parked-capsules/CapsuleVector";
import DynamicRouting from "../../../components/widgets/ch06/_parked-capsules/DynamicRouting";
import InvarianceVsEquivariance from "../../../components/diagrams/ch06/_parked-capsules/InvarianceVsEquivariance";
import CapsuleAnatomy from "../../../components/diagrams/ch06/_parked-capsules/CapsuleAnatomy";
import RoutingByAgreement from "../../../components/diagrams/ch06/_parked-capsules/RoutingByAgreement";

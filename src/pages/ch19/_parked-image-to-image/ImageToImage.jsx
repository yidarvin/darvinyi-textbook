// PARKED — not wired into any route. Image-to-Image Translation merges into
// Chapter 19 (GANs & Image-to-Image Translation) per the V2 curriculum
// (context/V2_PLAN.md, Appendix A: ch18). Queue item C19 folds the
// conditional-GAN + cycle-consistency spine from this file into GANs.jsx
// (compressing the SPADE material), then deletes this file. Its critique
// found 3 widgets with factually wrong numbers (param-count comparison
// reversed, SPADEBlock's own math doesn't check out, PatchGAN output-grid
// size implies non-overlapping tiling) — fix those during the merge, not
// carry them forward.
...
import ConditionalGeneration from "../../../components/widgets/ch19/_parked-image-to-image/ConditionalGeneration";
import Pix2pixArchitecture from "../../../components/widgets/ch19/_parked-image-to-image/Pix2pixArchitecture";
import PairedTranslation from "../../../components/widgets/ch19/_parked-image-to-image/PairedTranslation";
import CycleConsistency from "../../../components/widgets/ch19/_parked-image-to-image/CycleConsistency";
import CycleGANArchitecture from "../../../components/widgets/ch19/_parked-image-to-image/CycleGANArchitecture";
import SPADESynthesis from "../../../components/widgets/ch19/_parked-image-to-image/SPADESynthesis";
import ConditioningSpectrum from "../../../components/diagrams/ch19/_parked-image-to-image/ConditioningSpectrum";
import PatchGANDiscriminator from "../../../components/diagrams/ch19/_parked-image-to-image/PatchGANDiscriminator";
import CycleConstraintGeometry from "../../../components/diagrams/ch19/_parked-image-to-image/CycleConstraintGeometry";
import SPADEBlock from "../../../components/diagrams/ch19/_parked-image-to-image/SPADEBlock";

...
export default function EvaluatingLLMsAndAgents() {
  ...
  return <article style={{ maxWidth: 'var(--chapter-max-width, 740px)', margin: '0 auto', padding: 'var(--chapter-padding, 52px 44px 100px)' }}>
    ...
    <p style={prose}>Increase first-position bias, then verbosity bias. Notice that the same fixed human preferences yield different pairwise winners and an altered Elo-style aggregate.</p>
    <JudgeAgreementExplorer tryThis={{ do: 'Raise first-position bias, then raise verbosity bias.', notice: 'the displayed ranking can move even though the synthetic human-quality margins stay fixed.' }} />
